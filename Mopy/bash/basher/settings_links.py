...
class Settings_PluginEncodings(MenuLink):
    ...
    def __init__(self):
        ...
        unicode_utils.pluginEncoding = bass.settings['bash.pluginEncoding'] # TODO(ut): why is this init here ??
...
class Settings_PluginEncoding(RadioLink):
    ...
    def Execute(self):
        ...
        unicode_utils.pluginEncoding = self.encoding
...
class Settings_Deprint(CheckLink):
    ...
    def _check(self): return debugging.deprintOn

    def Execute(self):
        deprint(_(u'Debug Printing: Off'))
        debugging.deprintOn = not debugging.deprintOn
